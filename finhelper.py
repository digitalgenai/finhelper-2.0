    ...
    def criar_thread(self, contexto: str) -> str:
        ...
        self.client.beta.threads.messages.create(
            ...
            content=(
                ...
                "('Total Tarifa' + 'Total Taxas') menos 'Markup'. Quando o campo 'Diverg. Interna' mostra 'SIM', "
                "significa que essa regra foi violada naquele localizador — ou seja, "
                "Total Fornec. (-DF) ≠ (Total Tarifa + Total Taxas) - Markup. O campo 'Dif. Interna' mostra "
